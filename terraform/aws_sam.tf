...
# SAM Stack 
# ----------------------------------------------------------------------
resource "aws_cloudformation_stack" "e-commerce-api-sam-stack" {
  ...
  template_url = "https://${var.sam_code_bucket}.s3.amazonaws.com/${aws_s3_bucket_object.sam_deploy_object.id}"
}
